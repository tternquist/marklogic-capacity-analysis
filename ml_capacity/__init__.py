...
Module-internal helpers (underscore-prefixed names in submodules) are NOT
re-exported here. Tests and internal modules should import them directly from
the defining module, e.g. ``from ml_capacity.config_drift import _values_match``.
"""
...
from ml_capacity.config_drift import (
    extract_config_fingerprint, check_config_drift, report_config_drift,
)
from ml_capacity.index_analysis import (
    diff_index_memory, report_index_impact, wait_for_reindex,
)
